...
//###############################| SLIDER INIT |########################
    ...
    // if(document.querySelector('html').offsetWidth < 900){
    //     $('.road-map-tree').slick({
    //         slidesToShow: 1,
    //         slidesToScroll: 1,
    //         autoplay: true,
...
//#################################| TIMER |############################
    ...
    var countDown = new Date('Mar 31, 2018 00:00:00').getTime(),
    ...
    var navigationHamburger = (function () {
        return{
            init: function () {
                ...
                if(document.querySelector('html').offsetWidth <= 810){
...
//#################################| TEAM POP UP INFO |############################
    var teamPopUp = (function () {
        return{
            init:function () {
                var btn = $('.team-item__btn');
                btn.on('click',function () {
                    $(this).parent().siblings('.team__disc').slideToggle();
                })
            }
        }
    })();
