...
//################################| Slider Counter |#####################
$('.slider').on('init', function (sl, s) {
    $('.prev span').text(s.currentSlide + 1);
});
$('.slider').on('afterChange', function(event, slick, currentSlide, nextSlide){
    $('.prev span').text(currentSlide+1);
});
//################################| Hamburger Menu |#####################
