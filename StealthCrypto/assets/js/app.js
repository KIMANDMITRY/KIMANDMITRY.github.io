...
(function () {
    $(window).on('scroll',function () {
        if($(window).scrollTop() > 50) {
            $('.header__bottom').addClass('bgc');
        }else {
            $('.header__bottom').removeClass('bgc');
        }
    });
})();
//################################| Back To Top Button |###############
